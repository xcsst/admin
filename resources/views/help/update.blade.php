...
@section('title', '修改帮助信息')

@section('content')
    @include('layouts._content_header', ['items' => ['修改帮助信息']])
    <div class="col-xs-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">修改帮助信息</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::model($help, ['route' => ['help.doUpdate', 'id' => $help->id], 'class' => 'form-horizontal']) !!}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::radio('status', 1, $help->status == 1 ? true : false) !!} 显示
                        {!! Form::radio('status', -1, $help->status == -1 ? true : false) !!} 隐藏
                    </div>
                </div>
                <div class="form-group">
