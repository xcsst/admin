...
<head>
    ...
    <title>登录 - {{ config('params.project_name') }}</title>
...
<div class="login-box" style="width:500px;">
    <div class="login-logo">
        <a href="/"><b>{{ config('params.project_name') }}</b>后台管理系统</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <div class="form-group has-feedback">
            {!! Form::text('username', null, ['class' => 'form-control', 'placeholder' => '请输入登录帐号', 'maxlength' => 40]) !!}
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
            {!! Form::password('password', ['class' => 'form-control', 'placeholder' => '请输入登录密码', 'maxlength' => 40]) !!}
