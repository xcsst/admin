...
@section('content')
    @include('layouts._content_header', ['items' => ['修改公告']])
    <div class="col-xs-12">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::model($notice, ['route' => ['notice.doUpdate', 'id' => $notice->id], 'class' => 'form-horizontal']) !!}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::radio('status', 1, $notice->status == 1 ? true : false) !!} 显示
                        {!! Form::radio('status', -1, $notice->status == -1 ? true : false) !!} 隐藏
                    </div>
                </div>
                <div class="form-group">
