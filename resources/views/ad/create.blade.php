...
@section('content')
    @include('layouts._content_header', ['items' => ['添加广告']])
    <div class="col-xs-12">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['route' => ['ad.doCreate'], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="box-footer">
                ...
                <div class="col-xs-8">
                    {!! Form::submit('提  交', ['class' => 'btn btn-info btn-block']) !!}
                </div>
                <div class="col-xs-2"></div>
            </div>
            <!-- /.box-footer -->
