...
@section('title', '查看服务人员信息')

@section('content')
    @include('layouts._content_header', ['items' => ['查看服务人员信息']])
    <div class="col-xs-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">查看服务人员信息</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="box-body">
                ...
                @if(count($user->categorys))
                    <div class="form-group">
                        {!! Form::label('option', '服务项目', ['class' => 'col-sm-1 control-label']) !!}
                        <div class="col-sm-10">
                            @foreach ($user->categorys as $option)
            ...
            <div class="box-footer">
                ...
                <div class="col-xs-8">
                    {!! link_to_route('waiter.index', '返回', null, ['class' => 'btn btn-info btn-block']) !!}
                </div>
                <div class="col-xs-2"></div>
            </div>
            <!-- /.box-footer -->
